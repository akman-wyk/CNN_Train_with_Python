...
def my_train(batch_size, num_epochs, cut_percent, cut_weight_mode, model_file, acc_file):
    ...
    #                          cut_grad=True)
    model = models.MyResNet(weight_scale=0.1, cut_percent=cut_percent, cut_weight_mode=cut_weight_mode,
                            cut_weight=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--acc_file', type=str, default='./acc.txt')

    args = parser.parse_args()
    #
    # my_test(args.model_file)

    my_train(args.batch_size, args.num_epochs, args.cut_percent, args.cut_weight_mode, args.model_file, args.acc_file)
