...
class LeNet5(Net):
    ...
    def __init__(self, in_channels=1, out_channels=10, dropout=1.0, weight_scale=1e-2):
        ...
        self.conv1 = nn.Conv2d(in_channels, 5, 5, 6, stride=1, padding=0, weight_scale=weight_scale)
        self.conv2 = nn.Conv2d(6, 5, 5, 16, stride=1, padding=0, weight_scale=weight_scale)
        self.conv3 = nn.Conv2d(16, 5, 5, 120, stride=1, padding=0)
