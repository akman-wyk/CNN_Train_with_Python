...
class AlexNet(Net):
    ...
    def __init__(self, in_channels, out_channels, momentum=0, nesterov=False):
        ...
        self.conv1 = nn.Conv2d(in_channels, 11, 11, 96, stride=4, padding=0)
        self.conv2 = nn.Conv2d(96, 5, 5, 256, stride=1, padding=2)
        self.conv3 = nn.Conv2d(256, 3, 3, 384, stride=1, padding=1)
        self.conv4 = nn.Conv2d(384, 3, 3, 384, stride=1, padding=1)
        self.conv5 = nn.Conv2d(384, 3, 3, 256, stride=1, padding=1)
        ...
        self.fc1 = nn.FC(9216, 4096)
        self.fc2 = nn.FC(4096, 4096)
        self.fc3 = nn.FC(4096, out_channels)
